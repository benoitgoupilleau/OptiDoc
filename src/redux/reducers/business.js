...
const sysDocBusiness = {
  id: 'SysDoc',
  createdBy: 'raphaelled',
  updatedBy: 'raphaelled',
  createdOn: '2023-03-15T00:00:00',
  updatedOn: '2023-03-15T00:00:00',
  client: '',
  designation: 'Système documentaire',
  ligneMEtier: '',
  statut: '',
  description: '',
  idResponsable: null,
  adresse: '',
  datePreparation: '2023-03-15T00:00:00',
  dateRealisation: '2023-03-16T00:00:00',
  dateFinalisation: '2024-03-15T00:00:00',
  isSimplified: 'O',
};
...
export default (state = defaultState, action) => {
  switch (action.type) {
    ...
    case SET_BUSINESS:
      return {
        ...state,
        business: [sysDocBusiness, ...action.business],
      };
    case SET_ARBO:
      return {
        ...state,
